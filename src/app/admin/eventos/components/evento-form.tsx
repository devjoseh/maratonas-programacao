    ...
    return (
      <form action={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              ...
              <Input id="titulo" name="titulo" defaultValue={evento?.titulo} required disabled={isSubmitting} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="ETEC Abdias">ETEC Abdias</SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  name="data_inicio"
                  type="datetime-local"
                  defaultValue={evento?.data_inicio ? new Date(evento.data_inicio).toISOString().slice(0, 16) : ""}
                  required
                  disabled={isSubmitting || isFinalized}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  name="data_fim"
                  type="datetime-local"
                  defaultValue={evento?.data_fim ? new Date(evento.data_fim).toISOString().slice(0, 16) : ""}
                  required
                  disabled={isSubmitting || isFinalized}
                />
              </div>
            ...
            <div>
              ...
              <Select name="status" defaultValue={evento?.status || "planejado"} disabled={isSubmitting || isFinalized}>
                ...
                <SelectContent>
                  ...
                  {evento && <SelectItem value="finalizado">Finalizado</SelectItem>}
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="inscricao_externa">Inscrição Externa</Label>
                <Switch
              ...
              <p className="text-sm text-gray-500">
                Ative esta opção se as inscrições serão feitas em outro site (Google Forms, Even3, etc.)
              </p>
            </div>
  
            {inscricaoExterna && (
              <div>
                <Label htmlFor="url_inscricao_externa">URL para Inscrição Externa</Label>
                <Input
        ...
        <div className="space-y-2">
          ...
          <Editor value={descricao} onChange={setDescricao} disabled={isSubmitting} />
        </div>
  
        <div className="flex justify-end space-x-4">
          <Button type="button" variant="outline" onClick={() => router.push("/admin/eventos")} disabled={isSubmitting}>
            Cancelar
          </Button>
